...
产物：`build/distributions/stocklite-plugin-1.11.0.zip`
...
签名后产物在：`build/distributions/stocklite-plugin-1.11.0-signed.zip`
...
| 字段          | 填写内容                                |
|-------------|-------------------------------------|
| Plugin File | `stocklite-plugin-1.11.0-signed.zip` |
