...
产物：`build/distributions/stocklite-plugin-1.12.3.zip`
...
签名后产物在：`build/distributions/stocklite-plugin-1.12.3-signed.zip`
...
| 字段          | 填写内容                                |
|-------------|-------------------------------------|
| Plugin File | `stocklite-plugin-1.12.3-signed.zip` |
