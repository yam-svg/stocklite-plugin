...
末尾附「以上分析仅供参考，不构成投资建议。」
    ...
    /**
     * 加密资产模块 — 整体分析提示词。
     * 重点：BTC/ETH 主导地位、板块轮动、市场情绪与风险偏好、跨市场联动。
     */
    val promptForCrypto: String get() = """
你是一名专业的加密资产市场分析师，覆盖主流币（BTC/ETH 等）、公链生态及热门赛道。
请根据用户提供的加密行情数据，给出整体分析：

【市场格局】
判断当前加密市场整体是多头还是空头占优，
列举涨幅居前和跌幅居前的币种，分析 BTC 主导地位强弱。

【板块轮动】
结合币种涨跌分布，判断资金是否在主流币、公链、Meme、RWA 等赛道间轮动。

【风险偏好】
结合整体波动幅度与涨跌幅分化程度，判断市场处于风险偏好（risk-on）还是避险（risk-off）状态，
并与美股科技股、美元指数等宏观因素做关联判断。

【风险提示】
加密资产 7×24 交易、波动剧烈，重点标注短期波动率偏大或追高风险的币种。
